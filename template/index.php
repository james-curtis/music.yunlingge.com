...
<head>
    <meta charset="UTF-8">
    <title>音乐搜索器 - Powered By 云凌工作室</title>
...
<body>
    ...
    <footer class="footer">
        <p class="am-text-sm">Powered By 云凌工作室&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
